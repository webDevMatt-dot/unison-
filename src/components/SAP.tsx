...
const SapPage = () => {
  const service = {
    icon: <BriefcaseBusiness className="h-12 w-12 text-blue-600" />,
    pageTitle: 'Enterprise SAP Solutions',
    description: 'Leverage the power of SAP with our custom implementation, optimization, and support services. We help you streamline operations, gain real-time insights, and drive business growth with scalable and efficient SAP solutions.',
    features: [
